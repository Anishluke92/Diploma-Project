...
<form method="post" action="SignIn.php">
    ...
    <div class=" input-group">&nbsp;
        <button type="submit" class="btn btn-primary" name="SignIn_user">Sign In</button>
    </div>                       <!--If registered,now Signin -->
    <p>
        Not yet a member? <a href="Register.php">Register Here</a>  <!--If Signed In,now Register -->
    </p>
</form>
