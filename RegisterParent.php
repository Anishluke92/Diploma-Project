...
<div class="regi">
    <form method="post" action="RegisterParent.php">
        ...
        <div class="input-group3">
            ...
            <input type="radio" name="relation" value="married">Married
            <input type="radio" name="relation" value="single">Single
            <input type="radio" name="relation" value="divorced">Divorced
        </div>
        ...
        <div class="input-group">
            <label>Eircode:</label>
            <input type="text" name="eircode" required placeholder="Enter your Eir Code" >
        </div>

        <div class="input-group">&nbsp;
            <button type="submit" class="btn btn-primary" name="reg_user1">Submit</button>
        </div>                  <!--reg_user1 connects to the configure.php where the logic is present -->
